...
if __name__ == '__main__':
    ...
    # trainer = pl.Trainer(accelerator='gpu', max_epochs=args.max_epoch, log_every_n_steps=1, default_root_dir=folder_name)
    ...
    # gpu가 없으면 accelerator='cpu', 있으면 accelerator='gpu'
    trainer = pl.Trainer(accelerator='gpu', max_epochs=config['train_setting']['max_epoch'], log_every_n_steps=1, default_root_dir=folder_name)
